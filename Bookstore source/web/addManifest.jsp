...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <section class="py-5">
      <div class="container">
        <h2>Vendor Manifest</h2>
        <p>Please enter required information:</p>
        <form action="addVendor" method="POST">
            <p>
              Book Name: <input type="text" name="bookName" value="" size="50" /><br />
               <br>
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbspOrderID: <input type="text" name="orderId" value="" size="10" /><br />
                <br>
                &nbsp&nbsp&nbsp&nbsp&nbspQuantity: <select name="orderQty">
                    <option>0</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                ...
                <br>
                <br>
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPrice: <input type="text" name="wholesalePrice" value="" size="5" /><br />
                <br>
               &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Add Inventory" name="submit" />
            </p>
        </form>
      </div>
    </section>
